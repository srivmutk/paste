...
export default function Footer() {
  return (
    <>
      <nav className="flex items-center flex-wrap bg-gray-700 p-3 mb-96">
        <Link href="/">
        ...
        <div className="hidden w-full lg:inline-flex lg:flex-grow lg:w-auto">
          <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
            ...
            <a
              ...
              className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center hover:bg-blue-600 hover:text-white"
            >
              Source Code
            </a>
          </div>
